...
public abstract partial class ApproachProfile3D : Resource
{
    ...
    public abstract Vector3 Step(Vector3 start, Vector3 current, Vector3 target, float elapsed, float delta, IStatProvider? stats);
    ...
    public abstract bool IsComplete(Vector3 current, Vector3 target, float elapsed, IStatProvider? stats);
}
