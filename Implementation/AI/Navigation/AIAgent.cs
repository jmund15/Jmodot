...
public partial class AIAgent : Node3D
{
    ...
    [Export] private AIPerceptionManager _perceptionManager = null!;
    [Export] private AISteeringProcessor _steeringProcessor = null!;
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        var context = new SteeringDecisionContext(
            _perceptionManager,
        ...
        DesiredSteeringDirection = this._steeringProcessor.CalculateSteering(context, this._blackboard);
    ...
    #region GRANULAR_CONTROLS & SETUP
        ...
        {
            if (_perceptionManager == null) { return; }
            _perceptionManager.ProcessMode = isEnabled ? ProcessModeEnum.Inherit : ProcessModeEnum.Disabled;
        }
