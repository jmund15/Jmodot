...
/// Unlike IForceProvider2D, offsets don't accumulate or get dampened by friction.
/// </summary>
public interface IVelocityOffsetProvider2D
{
    /// <summary>
    ...
    Vector2 GetVelocityOffsetFor(Node2D target);
}
