...
/// Defines the distribution algorithm, shape, spacing, and density parameters.
...
public partial class PointCloudConfig : Resource
{
    ...
    /// <summary>
    /// Base shape that defines the point cloud boundaries.
    /// Sphere and Ellipsoid are most common for explosions.
    /// </summary>
    [Export]
    public PointCloudShape Shape { get; set; } = PointCloudShape.Sphere;
    ...
    /// Intended for maximum gap detection/fill algorithms in future versions.
    /// </summary>
    [Export(PropertyHint.Range, "0.1, 5.0, 0.1")]
