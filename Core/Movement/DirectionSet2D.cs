...
public abstract partial class DirectionSet2D : Resource
{
    ...
    //    {
    //        GD.PrintErr($"DirectionSet2D '{ResourceName}' has no directions defined.");
    ...
    //    {
    //        GD.PrintErr($"DirectionSet2D '{ResourceName}' contains invalid directions. All directions must be normalized and non-zero.");
    //        return -1; //TODO: throw exception instead? -1 should not be expected to be handled normally
    //    }
    //    int bestIdx = 0;
...
//        [Export] public Array<Vector2> Directions { get; private set; } = new();
